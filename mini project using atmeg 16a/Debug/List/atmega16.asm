...
; 0000 004D         ultoa_custom(frequency, buffer, 10);
	...
	LDS  R22,_frequency+2
	LDS  R23,_frequency+3
	CALL __PUTPARD1
	LDI  R30,LOW(_buffer)
...
; 0000 0059     frequency = 0;
	LDI  R30,LOW(0)
	STS  _frequency,R30
	STS  _frequency+1,R30
	STS  _frequency+2,R30
	STS  _frequency+3,R30
; 0000 005A }
	LD   R30,Y+
	RETI
; .FEND
...
; 0000 0066     period = current_capture - prev_capture;
	LDS  R26,_prev_capture_S0000003000
	LDS  R27,_prev_capture_S0000003000+1
	LDS  R24,_prev_capture_S0000003000+2
	LDS  R25,_prev_capture_S0000003000+3
	CALL SUBOPT_0x4
	CALL __SUBD12
	CALL __PUTD1S0
; 0000 0067 
...
; 0000 006C     prev_capture = current_capture;
	CALL SUBOPT_0x4
	STS  _prev_capture_S0000003000,R30
	STS  _prev_capture_S0000003000+1,R31
	STS  _prev_capture_S0000003000+2,R22
	STS  _prev_capture_S0000003000+3,R23
; 0000 006D }
	ADIW R28,8
	LD   R30,Y+
	OUT  SREG,R30
